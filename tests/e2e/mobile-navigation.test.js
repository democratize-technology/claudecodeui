describe('Mobile Navigation E2E Tests', () => {
  ...
  test('should open and close mobile menu with touch interactions', async () => {
    ...
    const hamburgerButton = await page.$('[data-testid="hamburger-menu"], [data-testid="menu-button"], .hamburger, .menu-button, .mobile-menu-button, [class*="hamburger"], [class*="menu-toggle"], button[class*="menu"]');
    expect(hamburgerButton).not.toBeNull();
    ...
    await global.simulateMobileTouch(page, '[data-testid="hamburger-menu"], [data-testid="menu-button"], .hamburger, .menu-button, .mobile-menu-button, [class*="hamburger"], [class*="menu-toggle"], button[class*="menu"]');
    ...
    if (!menuVisible) {
      ...
      menuVisible = bodyClasses.includes('menu-open') || 
