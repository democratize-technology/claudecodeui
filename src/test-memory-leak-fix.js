  ...
  const testInterval = setInterval(() => {
    ...
    setTimeout(() => {
      ...
      if (componentCounter % 10 === 0) {
        console.log(
          `✅ Completed ${componentCounter} mount/unmount cycles - checking for memory leaks...`
        );
        ...
        if (componentCounter >= 50) {
          ...
          console.log(
            '📊 If no "clearTimeout called on null/undefined" errors appeared, the fix is working'
          );
        }
      }
