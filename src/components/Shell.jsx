      ...
      <div className='flex-shrink-0 bg-gray-800 border-b border-gray-700 px-4 py-2'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center space-x-2'>
            ...
            {!selectedSession && <span className='text-xs text-gray-400'>(New Session)</span>}
            {!isInitialized && <span className='text-xs text-yellow-400'>(Initializing...)</span>}
            {isRestarting && <span className='text-xs text-blue-400'>(Restarting...)</span>}
          </div>
