                  ...
                  <div className='space-y-6 md:space-y-8'>
                    ...
                    <div className='bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4'>
                      ...
                      <ul className='text-sm text-blue-800 dark:text-blue-200 space-y-1'>
                        ...
                        <li>
                          <code className='bg-blue-100 dark:bg-blue-800 px-1 rounded'>"Write"</code>{' '}
                          - Allow all Write tool usage
                        </li>
                        <li>
                          <code className='bg-blue-100 dark:bg-blue-800 px-1 rounded'>"Read"</code>{' '}
                        ...
                        <div className='bg-background border border-border rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto'>
                          ...
                          <form onSubmit={handleMcpSubmit} className='p-4 space-y-4'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                              <div
                                className={mcpFormData.importMode === 'json' ? 'md:col-span-2' : ''}
                              >
                                <label className='block text-sm font-medium text-foreground mb-2'>
                                  Server Name *
                                </label>
                ...
                {toolsProvider === 'cursor' && (
                  <div className='space-y-6 md:space-y-8'>
                    ...
                    <div className='space-y-4'>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Shell commands that are automatically allowed without prompting for
                        permission
                      </p>
                        ...
                        <Input
                          ...
                          onKeyPress={(e) => {
                            if (e.key === 'Enter') {
                              if (
                                newCursorCommand &&
                                !cursorAllowedCommands.includes(newCursorCommand)
                              ) {
                                setCursorAllowedCommands([
                                  ...cursorAllowedCommands,
                                  newCursorCommand
                                ]);
                                setNewCursorCommand('');
                              }
                        ...
                        {cursorAllowedCommands.map((cmd) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                setCursorAllowedCommands(
                                  cursorAllowedCommands.filter((c) => c !== cmd)
                                )
                              }
                              className='text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300'
                            >
                      ...
                      <div className='flex flex-col sm:flex-row gap-2'>
                        <Input
                          ...
                          onKeyPress={(e) => {
                            if (e.key === 'Enter') {
                              if (
                                newCursorDisallowedCommand &&
                                !cursorDisallowedCommands.includes(newCursorDisallowedCommand)
                              ) {
                                setCursorDisallowedCommands([
                        ...
                        {cursorDisallowedCommands.map((cmd) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                setCursorDisallowedCommands(
                                  cursorDisallowedCommands.filter((c) => c !== cmd)
                                )
                              }
                              className='text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300'
                            >
                    ...
                    <div className='bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4'>
                      ...
                      <ul className='text-sm text-purple-800 dark:text-purple-200 space-y-1'>
                        ...
                        <li>
                          ...
                          flag - Skip all permission prompts (dangerous)
                        </li>
                      </ul>
                    </div>
                  </div>
                        ...
                        <div className='flex items-start gap-3'>
                          ...
                          <div className='flex-1'>
                            ...
                            <div className='text-sm text-orange-800 dark:text-orange-200 space-y-3'>
                              <p>
                                TaskMaster CLI is required to use task management features. Install
                                it to get started:
                              </p>
                        ...
                        <div className='flex items-center justify-between'>
                          <div>
                            ...
                            <div className='text-sm text-muted-foreground mt-1'>
                              Show TaskMaster tasks, banners, and sidebar indicators across the
                              interface
                            </div>
                            {!isTaskMasterInstalled && (
                          ...
                          <label className='relative inline-flex items-center cursor-pointer'>
                            ...
                            />
                            <div
                              className={`w-11 h-6 ${!isTaskMasterInstalled ? 'bg-gray-300 dark:bg-gray-600' : 'bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800'} rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600`}
                            ></div>
                          </label>
                        </div>
                      </div>
                        ...
                        <div className='flex items-start gap-3'>
                          ...
                          <div>
                            ...
                            <div className='text-sm text-blue-800 dark:text-blue-200 space-y-2'>
                              <p>
                                <strong>AI-Powered Task Management:</strong> Break complex projects
                                into manageable subtasks with AI assistance
                              </p>
                              <p>
                                <strong>PRD:</strong> Generate structured tasks from Product
                                Requirements Documents
                              </p>
                              <p>
                                <strong>Dependency Tracking:</strong> Understand task relationships
                                and execution order
                              </p>
                              <p>
                                <strong>Progress Visualization:</strong> Kanban boards, and detailed
                                task views
                              </p>
                            </div>
                          </div>
                          ...
                          <div className='mt-4 pt-4 border-t border-blue-200 dark:border-blue-700'>
                            <div className='flex items-start gap-3'>
                              ...
                              <div className='flex-1'>
                                ...
                                <div className='text-sm text-blue-800 dark:text-blue-200 space-y-2'>
                                  <p>
                                    TaskMaster AI (aka <strong>claude-task-master</strong> ) is an
                                    advanced AI-powered task management system built for developers.
                                  </p>
                                  <div className='flex flex-col gap-2'>
                                    ...
                                    <p className='text-xs text-blue-700 dark:text-blue-300'>
                                      Find documentation, setup guides, and examples for advanced
